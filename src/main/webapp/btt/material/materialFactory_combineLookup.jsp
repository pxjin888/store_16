	...
	<table class="table" layoutH="118" targetType="dialog" width="100%">
		<thead>
			<tr>
				...
				<th width="150">供应商及详情</th>
			</tr>
		</thead>
		<tbody>
			<s:iterator value="#request.material_list">
			<tr>
				<td><input type="checkbox" name="materialId" value="{materialId:'<s:property value="materialId"/>', materialName:'<s:property value="materialName"/>'}"/></td>
				...
				<td>
					<input name="factory.name" type="text"/>
					<a class="btnLook" href="btt/material/materialFactory_factoryLookup.jsp" lookupGroup="factory">查找带回</a>
				</td>
			</tr>
			</s:iterator>
		</tbody>
