...
<div class="pageHeader">
	...
	<div class="searchBar">
		...
		<table class="searchContent">
			<tr>
				<td>
					用户组名称：<input type="text" name="keyword" />
				</td>
				<td>
					<select class="combox" name="province">
						<option value="">所有省市</option>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/group_addDisplay.action" target="dialog" ><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			<s:iterator value="#request.group_list">
